<template>
  ...
  <div class="hello">
    <h1
      v-if="isAdmin"
      style="font-size: 48px; font-weight: 700; margin: 48px 0"
    >
      ...
      <form @submit.prevent="postAppointment()">
        ...
        <div class="form-group">
          ...
          <select
            id="Status"
            class="form-control"
            v-model="newAppointmentData.status"
            required
          >
      ...
      <form @submit.prevent="updateAppointment()">
        <div class="form-group">
          ...
          <select
            id="patientName"
            class="form-control"
            v-model="editAppointmentData.patientID"
            required
          >
        ...
        <div class="form-group">
          ...
          <select
            id="doctorName"
            class="form-control"
            v-model="editAppointmentData.doctorID"
            required
          >
        ...
        <div class="form-group">
          ...
          <select
            id="Status"
            class="form-control"
            v-model="editAppointmentData.status"
            required
          >
            <option value="" disabled selected>Status</option>
            <option value="Pending">Pending</option>
  ...
  methods: {
    fetchAppointments() {
      if (this.isAdmin) {
        ...
        fetch(
          "http://127.0.0.1:8000/api/appointments?doctorID=" + this.user.id,
          {
            method: "GET",
            headers: {
              "Content-Type": "application/json",
        ...
        fetch(
          "http://127.0.0.1:8000/api/appointments?patientID=" + this.user.id,
          {
            method: "GET",
            headers: {
              "Content-Type": "application/json",
    ...
    async updateAppointment() {
      ...
      await axios.put(
        `http://127.0.0.1:8000/api/appointments/${this.editAppointmentData.id}`,
